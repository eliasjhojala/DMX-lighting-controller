...
void loadAllData() {
  ...
  if(userId == 1) {
   table = loadTable("/Users/elias/Dropbox/DMX controller/main/variables/pikkusten_disko.csv", "header"); //Eliaksen polku
  }
  else {
   table = loadTable("E:\\Dropbox\\DMX controller\\main\\variables\\pikkusten_disko.csv", "header"); //Roopen polku
  }
